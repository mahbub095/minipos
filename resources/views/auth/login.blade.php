...
<head>
    ...
    <link type="text/css" rel="stylesheet" href="{{('backend/login/assets/fonts/font-awesome/css/font-awesome.min.css')}}">
    ...
    <div class="row no-gutters">
        ...
        <div class="col-md-6 mobile-hidden">
            <div class="login_left">
                <div class="login_left_img"><img src="{{('backend/login/images/login-bg.jpg')}}" alt="login background"></div>
            </div>
        </div>
